...
function bind(){
 ...
 document.querySelectorAll('[data-delete-subject]').forEach(b=>b.addEventListener('click',async()=>{if(!confirm('Delete this subject and all its questions?'))return;try{await 
